...
| `<ldr />`                      | [`LightDependentResistorProps`](#lightdependentresistorprops-ldr)                          |
...
### LightDependentResistorProps `<ldr />`
...
[Source](https://github.com/tscircuit/props/blob/main/lib/components/ldr.ts)
