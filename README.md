...
| `<silkscreenpill />`           | [`SilkscreenPillProps`](#silkscreenpillprops-silkscreenpill)                               |
...
### SilkscreenPillProps `<silkscreenpill />`

```ts
export type SilkscreenPillProps = z.input<typeof silkscreenPillProps>;
```

[Source](https://github.com/tscircuit/props/blob/main/lib/components/silkscreen-pill.ts)
